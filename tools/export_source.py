...
ALLOWLIST = (
    ...
    "kernel/hdmi/README.md", "kernel/hdmi/build-input.lock.json",
    "kernel/hdmi/0001-drm-sunxi-keep-atomic-output-state-across-hpd.patch",
    "tools/build.py", "tools/build_gpu_kmod.py", "tools/build_hdmi_kernel.py", "tools/desktop.py", "tools/export_build_audit.py", "tools/export_source.py",
    ...
    "runtime/a7z-grow-root", "runtime/a7z-grow-root.service", "runtime/a7z-install-ufs", "runtime/a7z-hdmi-migrate",
    "runtime/a7z-keyring-init", "runtime/a7z-keyring-init.service",
    "runtime/boot/50-a7z-boot-snapshot.hook", "runtime/boot/92-a7z-hdmi-migrate.hook", "runtime/boot/99-a7z-boot-update.hook",

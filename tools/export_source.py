...
ALLOWLIST = (
    ...
    "tools/package_gpu.py", "tools/personalize.py", "tools/rootfs.py", "tools/sanitize.py", "tools/sources.py",
    "runtime/a7z-boot-update", "runtime/a7z-firstboot", "runtime/a7z-firstboot.service",
    "runtime/a7z-grow-root", "runtime/a7z-grow-root.service", "runtime/a7z-install-ufs",
